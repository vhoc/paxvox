...
const App = () => {
  ...
  return (
    ...
    <div className="App">
        <Routes>
          <Route exact path='/encuestas/obregon' element={ <Main sucursal={1} /> }/>
          <Route exact path='/encuestas/guaymas' element={ <Main sucursal={2} /> }/>
          <Route exact path='/encuestas/hermosillo' element={ <Main sucursal={3} /> }/>
        </Routes>
    </div>
